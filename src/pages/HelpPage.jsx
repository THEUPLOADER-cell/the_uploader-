...
export default function HelpPage() {
  const title = 'Help & Guidance | THE UPLOADER'
  const description =
    'Learn how to use THE UPLOADER to upload, process, and download your files safely on your own device.'
  const canonical = canonicalUrl('/help')
